...
export default function BuyerOrdersPage() {
    ...
    const { data, isLoading, isError } = useBuyerOrders(filters);
        ...
        <div className="rounded-3xl border border-emerald-100 bg-white/80 backdrop-blur p-6 shadow-sm">
          <div className="flex flex-col gap-2">
            <h1 className="text-2xl font-extrabold tracking-tight text-emerald-950">
              My Orders
              <span className="ml-2 text-sm font-semibold text-emerald-700">(Buyer)</span>
            </h1>
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-2">
                      <p className="text-sm font-extrabold text-emerald-950">#{o.order_id}</p>
                    ...
                    <div className="mt-2 flex flex-wrap gap-x-4 gap-y-1 text-sm text-emerald-900/75">
                      <p>
                        <span className="font-semibold text-emerald-900">Qty:</span>{" "}
                        {o.quantity} {o.unit}
                      </p>
                      <p>
