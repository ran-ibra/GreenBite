  ...
  return (
    <footer className="footer sm:footer-horizontal bg-[white] text-base-content p-10">
      <nav>
        ...
        <NavLink to="/home/foodlog" className="link link-hover">
          Food Log
        </NavLink>
        <NavLink to="/home/wastelog" className="link link-hover">
          Waste Log
        </NavLink>
        <NavLink to="/home/ai-recipes" className="link link-hover">
          Ai Recipes
        </NavLink>
      </nav>
      ...
      <nav>
        ...
        <NavLink to="/#offers" className="link link-hover">
          Offers
        </NavLink>
      </nav>
